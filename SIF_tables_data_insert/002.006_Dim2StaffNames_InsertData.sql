...
-- Switched from left to inner join
-- There are 3 staff in nhPerson not in silver.Staff
-- These 3 staff have no valid LocalId or RefId foreign keys to be allowed into Dim2StaffNames
INNER JOIN [cdm_demo_gold].[Dim1StaffPersonal] as s
ON n.LocalId = s.LocalId
)
INSERT INTO cdm_demo_gold.Dim2StaffNames (
       StaffRefId
      ,StaffLocalId
      ,FamilyName
      ,GivenName
